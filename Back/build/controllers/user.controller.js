...
exports.updateMe = exports.getMe = exports.remove = exports.update = exports.getOne = exports.getAll = exports.create = void 0;
...
exports.getAll = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    new ApiResponse_1.SuccessResponsePaginate('All users returned successfuly', result.docs, result.meta).send(res);
});
