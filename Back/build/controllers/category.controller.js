...
exports.create = (0, asyncHandler_1.default)(async (req, res) => {
    const { body, file } = req;
    const result = await category_1.default.create({ body, file });
...
exports.getAll = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    new ApiResponse_1.SuccessResponsePaginate('All categorys returned successfuly', result.docs, result.meta).send(res);
});
...
exports.update = (0, asyncHandler_1.default)(async (req, res) => {
    const { id } = req.params;
    const { body, file } = req;
    const result = await category_1.default.update({ id, body, file });
